...
Rectangle{
    id: rootId
    property string okButtonUpSource: "images/okup.png"
    property string okButtonDownSource: "images/okdown.png"
    ...
    border.width: 4
    z:1
    opacity: MainViewMgr.feedbackOkButtonVisible ? 0.9 : 0.5
    ...
    Rectangle{
        ...
        Text{
            ...
            clip:true
            elide:Qt.ElideRight
            color: MainViewMgr.feedbackOkButtonVisible? errorText : normalText
        ...
        Image{
            ...
            MouseArea{
                ...
                onClicked: {MainViewMgr.feedbackAreaVisible = false
                            MainViewMgr.instrumentControlEnabled = true}
            }
        }
    }
}
