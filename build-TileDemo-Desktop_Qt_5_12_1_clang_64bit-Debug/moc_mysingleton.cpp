...
#include "../TileDemo/mysingleton.h"
...
QT_MOC_LITERAL(1, 12, 15), // "appTitleChanged"
QT_MOC_LITERAL(2, 28, 0), // ""
QT_MOC_LITERAL(3, 29, 5), // "value"
QT_MOC_LITERAL(4, 35, 11), // "changeTitle"
QT_MOC_LITERAL(5, 47, 8) // "appTitle"

    },
    "MySingleton\0appTitleChanged\0\0value\0"
    "changeTitle\0appTitle"
};
...
void MySingleton::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->appTitleChanged((*reinterpret_cast< QString(*)>(_a[1]))); break;
        case 1: { QString _r = _t->changeTitle();
        ...
        {
            using _t = void (MySingleton::*)(QString );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MySingleton::appTitleChanged)) {
                *result = 0;
                return;
            }
        }
        ...
        void *_v = _a[0];
        switch (_id) {
        case 0: *reinterpret_cast< QString*>(_v) = _t->appTitle(); break;
        default: break;
        }
        ...
        void *_v = _a[0];
        switch (_id) {
        case 0: _t->appTitle(*reinterpret_cast< QString*>(_v)); break;
        default: break;
        }
...
// SIGNAL 0
void MySingleton::appTitleChanged(QString _t1)
{
